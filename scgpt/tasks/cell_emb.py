...
def get_batch_cell_embeddings(
    ...
    if cell_embedding_mode == "cls":
        ...
        with torch.no_grad(), torch.cuda.amp.autocast(enabled=True):
            ...
            for batch, data_dict in enumerate(itertools.islice(data_loader, num_batches)):
                ...
                print('embeddings0.shape', embeddings.shape)
                embeddings = embeddings[:, 0, :]  # get the <cls> position embedding
                print('embeddings1.shape', embeddings.shape)
...
def embed_data(
...
) -> AnnData:                  #     adata, "../../save/scGPT_human", gene_col=gene_col, batch_size=64,
    """
    ...
    model_file = save_dir / "best_model_batch_7.pt"
    pad_token = "<pad>"
    ...
    print('CELL EMBEDDINGS ADDED TO adata.obsm["X_scGPT"]', cell_embeddings.shape)
    return adata
