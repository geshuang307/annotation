...
def init_unit_important(model: nn.Module, loader: DataLoader) -> None:
    """
    ...
    for batch, batch_data in enumerate(loader):
        ...
        with torch.cuda.amp.autocast(enabled=config['amp']):
            ...
            loss_kd = kd_loss(output_dict["mlm_output"], output_dict1["mlm_output"])    
            loss_kd.backward()
    ...
    fc1_impt /= tot_tokens     # 对全部的样本都很重要的参数,梯度大表示重要
    fc2_impt /= tot_tokens
    ...
    ############ 保存重要性权重 ############
    torch.save(fc1_impt, save_dir /'fc1_impt.pt')
    torch.save(fc2_impt, save_dir / 'fc2_impt.pt')
...
if __name__=='__main__':
    ...
    init_unit_important(model, loader=train_loader)
    print()
