...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
        ...
        self.linear1 = Linear(d_model, dim_feedforward, bias=bias, **factory_kwargs) # 在这一步加mask (dim_feedforward, 1)
        self.dropout = Dropout(dropout)
        self.linear2 = Linear(dim_feedforward, d_model, bias=bias, **factory_kwargs) # 在这一步加mask (d_model, 1)
